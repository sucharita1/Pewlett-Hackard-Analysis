...
The first few elements of the queries can be found in ![retiring_titles](?raw=true)
...
by performing a join with employee, dept_emp and titles table after filtering the data on the to_date column to all the current employees, ordering by employee numberand and exporting table as [mentorship_eligibilty.csv]() 
![mentorship_eligibilty](?raw=true)

The first few elements of the queries can be found in ![Employee_Database_challenge](?raw=true)
...
The first few elements of the queries can be found in ![retiring_titles_still_working](?raw=true)
